"""Download the Zomato Restaurants dataset from Kaggle into ./data/.
...
def main() -> None:
    # Imported lazily so `python download_data.py --help`-style usage doesn't
    # require kaggle.json to exist just to parse args.
